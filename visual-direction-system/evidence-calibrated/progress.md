...
> This file is intentionally conservative. A frame counts as `Viewed` only after its image was actually loaded and visually reviewed.
...
Every source frame should ultimately have:

- `Review_Status = VIEWED`
- at least `Review_Level = L1`
- a Scene / Shot Cluster assignment
- core structural annotations

Selected frames then receive L2/L3 analysis.
...
3. Miguel / Spider Society
4. Hobie / punk rendering and temporal behavior
5. Mumbattan
6. cross-character close-up facial rendering
7. environment / worldbuilding
8. camera / composition families
9. color scripts
10. rendering / texture families
11. motion / temporal FX
12. world transition / collision
13. visual silence / quiet scenes
14. climax / agency / visual authorship
